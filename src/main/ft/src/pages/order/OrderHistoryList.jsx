                  ...
                  <Table>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell style={{ textAlign: 'center' }}>배송지</TableCell>
                    ...
                    <TableBody>
                      {ordersForThisDate.map((order, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell style={{ borderRight: '1px solid rgba(224, 224, 224, 1)', textAlign: 'center' }}>({order.postCode}){order.addr} {order.detailAddr}</TableCell>
                          <TableCell style={{ borderRight: '1px solid rgba(224, 224, 224, 1)', textAlign: 'center' }}>
                            {order.way ? (
